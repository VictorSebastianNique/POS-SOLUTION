                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <CustomSelect 
                      ...
                      onChange={v => setCatalogForm({...catalogForm, unit_of_measure: v})}
                      options={[{value:'UNIDAD',label:'Unidad'}, {value:'KG',label:'Kilogramo'}, {value:'LITRO',label:'Litro'}, {value:'PRESA',label:'Presa'}]}
                    />
                  </div>
                </div>
                <div>
