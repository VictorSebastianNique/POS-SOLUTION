...
const OrderCard = ({ order, currentTime, dispatchOrderItems, setConfirmDispatch }) => {
  ...
  return (
    <div className="card animate-fade-in flex flex-col" style={{ borderTop: `4px solid ${getStatusColor(order.status)}`, backgroundColor: 'var(--surface-color)', padding: '0.75rem', height: '420px', display: 'flex', flexDirection: 'column' }}>
